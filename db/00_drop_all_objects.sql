...
-- Tablas con FK (hijas)
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_ORDEN_PAGO_PRODUCCION CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_ORDEN_PAGO_PRODUCCION'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_ORDEN_PAGO_LIQUIDACION CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_ORDEN_PAGO_LIQUIDACION'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_ORDEN_PAGO_APROBACION CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_ORDEN_PAGO_APROBACION'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_PERFIL_APROBACION_USUARIO CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_PERFIL_APROBACION_USUARIO'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_SEG_USUARIO_SEDE CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_SEG_USUARIO_SEDE'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_ORDEN_PAGO CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_ORDEN_PAGO'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE SHM_PERFIL_APROBACION CASCADE CONSTRAINTS'; DBMS_OUTPUT.PUT_LINE('Tabla eliminada: SHM_PERFIL_APROBACION'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_ORDEN_PAGO_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_ORDEN_PAGO_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_ORDEN_PAGO_PRODUCCION_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_ORDEN_PAGO_PRODUCCION_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_ORDEN_PAGO_LIQUIDACION_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_ORDEN_PAGO_LIQUIDACION_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_ORDEN_PAGO_APROBACION_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_ORDEN_PAGO_APROBACION_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_PERFIL_APROBACION_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_PERFIL_APROBACION_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_PERFIL_APROB_USUARIO_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_PERFIL_APROB_USUARIO_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SHM_SEG_USUARIO_SEDE_SEQ'; DBMS_OUTPUT.PUT_LINE('Secuencia eliminada: SHM_SEG_USUARIO_SEDE_SEQ'); EXCEPTION WHEN OTHERS THEN IF SQLCODE != -2289 THEN RAISE; END IF; END;
/
