# Requerimiento de Servicios API-REST - IQSOFT
...
Solicitar al proveedor de IQSOFT el desarrollo de servicios API-REST que permitan al Sistema de Honorarios Medicos (SHM) consultar:
...
> **Nota:** Las URLs de los endpoints, nombres de campos en el IQSOFT, mecanismo de autenticacion y seguridad seran definidos por el proveedor IQSOFT.

---

## 3. Servicios Requeridos

### 3.1 Servicio 1: Obtener Cuentas Bancarias por Correntista

**Descripcion:** Obtener las cuentas bancarias registradas en IQSOFT para un acreedor especifico.

#### Parametro de Entrada

| Parametro | Tipo | Obligatorio | Descripcion |
|-----------|------|-------------|-------------|
| Codigo Correntista | string | Si | Codigo del Correntista en IQSOFT |

#### Datos de Salida Requeridos

| Dato | Descripcion |
|------|-------------|
| Codigo Correntista | Codigo del correntista en IQSOFT |
...
**Descripcion:** Obtener el catalogo completo de bancos disponibles en IQSOFT.
...
**Descripcion:** Consultar el estado y datos del pago realizado para una factura especifica de un Correntista.
...
| Dato | Descripcion |
|------|-------------|
| Codigo Correntista | Codigo del Correntista |
...
|---|----------|----------------------|-----------------|
| 1 | Cuentas Bancarias por Correntista | Codigo Correntista | Cuentas bancarias con banco y moneda |
| 2 | Datos de Banco | Codigo Banco | Codigo y descripcion del banco |
| 3 | Lista de Bancos | Ninguno | Catalogo completo de bancos |
| 4 | Datos de Pago de Factura | Codigo Correntista, Tipo Comprobante, Serie, Numero | Estado pago, fecha, operacion, banco, cuenta, monto |

---

## 5. Consideraciones Tecnicas (Para el Proveedor)

### 5.1 Definiciones a Cargo del Proveedor IQSOFT

El proveedor IQSOFT debera definir y documentar:
