...
/// <summary>
/// Entidad que representa la relacion entre una orden de pago y una produccion.
/// Mapea a la tabla SHM_ORDEN_PAGO_PRODUCCION en la base de datos.
///
/// <author>ADG Antonio</author>
/// <created>2026-02-03</created>
/// <modified>ADG Antonio - 2026-02-07 - Renombrado de OrdenPagoLiquidacion a OrdenPagoProduccion</modified>
/// </summary>
public class OrdenPagoProduccion
{
